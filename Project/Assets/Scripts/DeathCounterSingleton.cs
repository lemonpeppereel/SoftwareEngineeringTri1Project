...
public class DeathCounterSingleton : MonoBehaviour
{

    private static DeathCounterSingleton _instance;
    public static DeathCounterSingleton Instance { get { return _instance; }} 
